  ...
  <body>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
			<p class="navbar-text pull-right"><a href="#myModal" data-toggle="modal" class="navbar-link">Sign In</a></p>
            <ul class="nav">
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-body">
		...
		Belum punya akun? <a href="register_user.php" >Daftar Disini Om</a>
	  </div>
	</div>
